...
class DiscoveryScreenV5 extends StatefulWidget {
  const DiscoveryScreenV5({super.key});

  @override
  State<DiscoveryScreenV5> createState() => _DiscoveryScreenV5State();
}

class _DiscoveryScreenV5State extends State<DiscoveryScreenV5> with SingleTickerProviderStateMixin {
