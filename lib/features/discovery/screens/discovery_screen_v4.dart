...
/// Variation 4 - Signature experience inspired by V2 but elevated further.
/// Features:
/// - Immersive hero carousel with gradient overlays and live meta.
/// - Cinematic signature cards with dual-tone backgrounds.
/// - Category quick filters and spotlight stats.
class DiscoveryScreenV4 extends StatefulWidget {
  const DiscoveryScreenV4({super.key});

  @override
  State<DiscoveryScreenV4> createState() => _DiscoveryScreenV4State();
}

class _DiscoveryScreenV4State extends State<DiscoveryScreenV4> with SingleTickerProviderStateMixin {
                    ...
                    delegate: SliverChildListDelegate([
                      if (featured.isNotEmpty)
                        Padding(
                          ...
                          child: _buildHeroCarousel(themeService, featured),
                        ),
                      Padding(
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  _buildHeroStat(
                                    label: 'Experience',
                                    value: '${astrologer.experience} yrs',
                                  ),
                                  const SizedBox(width: 12),
                                  _buildHeroStat(
                                    label: 'Sessions',
                                    value: _formatNumber(astrologer.totalConsultations),
                                  ),
                                ],
                              ),
                            ],
...
class _CompactGridCardV4 extends StatelessWidget {
  final DiscoveryAstrologer astrologer;
  final ThemeService themeService;
  final VoidCallback onTap;
  final VoidCallback onChatTap;

  const _CompactGridCardV4({
